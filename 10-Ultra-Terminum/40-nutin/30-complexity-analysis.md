...
\bigtodo{look for references to 'layer2' and change to nesting as appropriate.}
...
|--------|---|----|----|----|
| $1000, \nicefrac{1}{15}, \nicefrac{1}{15}, 112, 250$ | 4 | 240 | 8,036 | 482,143 |
| $3000, \nicefrac{1}{15}, \nicefrac{1}{15}, 112, 250$ | 12 | 2,160 | 216,964 | $3.9\times 10^{7}$ |
| $30000, \nicefrac{1}{15}, \nicefrac{1}{15}, 112, 250$ | 120 | 216,000 | $2.2\times 10^{8}$ | $3.9\times 10^{11}$ |
| $1000, \nicefrac{1}{60}, \nicefrac{1}{60}, 112, 250$ | 4 | 960 | 128,571 | $3.1\times 10^{7}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 112, 250$ | 12 | 8,640 | $3.5\times 10^{6}$ | $2.5\times 10^{9}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 112, 500$ | 12 | 4,320 | $1.7\times 10^{6}$ | $6.2\times 10^{8}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 200, 250$ | 12 | 8,640 | $1.9\times 10^{6}$ | $1.4\times 10^{9}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 200, 500$ | 12 | 4,320 | 972,000 | $3.5\times 10^{8}$ |
| $30000, \nicefrac{1}{60}, \nicefrac{1}{60}, 200, 200$ | 120 | $1.1\times 10^{6}$ | $2.4\times 10^{9}$ | $2.2\times 10^{13}$ |
| $30000, \nicefrac{1}{60}, \nicefrac{1}{60}, 112, 200$ | 120 | $1.1\times 10^{6}$ | $4.3\times 10^{9}$ | $3.9\times 10^{13}$ |
| $1000, \nicefrac{1}{600}, \nicefrac{1}{600}, 112, 250$ | 4 | 9,600 | $1.3\times 10^{7}$ | $3.1\times 10^{10}$ |
| $3000, \nicefrac{1}{600}, \nicefrac{1}{600}, 200, 250$ | 12 | 86,400 | $1.9\times 10^{8}$ | $1.4\times 10^{12}$ |
| $3000, \nicefrac{1}{600}, \nicefrac{1}{600}, 112, 250$ | 12 | 86,400 | $3.5\times 10^{8}$ | $2.5\times 10^{12}$ |
| $30000, \nicefrac{1}{600}, \nicefrac{1}{600}, 200, 200$ | 120 | $1.1\times 10^{7}$ | $2.4\times 10^{11}$ | $2.2\times 10^{16}$ |
| $30000, \nicefrac{1}{600}, \nicefrac{1}{600}, 112, 200$ | 120 | $1.1\times 10^{7}$ | $4.3\times 10^{11}$ | $3.9\times 10^{16}$ |
| $1000, \nicefrac{1}{60}, \nicefrac{1}{600}, 112, 250$ | 4 | 9,600 | $1.3\times 10^{6}$ | $3.1\times 10^{9}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{600}, 112, 250$ | 12 | 86,400 | $3.5\times 10^{7}$ | $2.5\times 10^{11}$ |
| $30000, \nicefrac{1}{60}, \nicefrac{1}{600}, 112, 250$ | 120 | $8.6\times 10^{6}$ | $3.5\times 10^{10}$ | $2.5\times 10^{15}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 500, 500$ | 12 | 4,320 | 388,800 | $1.4\times 10^{8}$ |
| $3000, \nicefrac{1}{60}, \nicefrac{1}{60}, 500, 700$ | 12 | 3,086 | 277,714 | $7.1\times 10^{7}$ |

: A comparison of the maximum transaction throughput given different scaling configurations.

\bigtodo{add figure of graphs of $B_f$ a/or $D_f$ vs tps, $B_h$ a/or $D_h$ vs tps, tx-size vs tps, k vs tps}
