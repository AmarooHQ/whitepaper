...
|------|---|------|----|----|----|
| $1000, \nicefrac{1}{15}, 16, 84$     | 4      | 714                 | 938                 | 167,411              | $2.99\times 10^{7}$  |
...
| $3000, \nicefrac{1}{15}, 16, 84$     | 12     | 6,429               | 8,438               | $4.52\times 10^{6}$  | $2.42\times 10^{9}$  |
...
| $3000, \nicefrac{1}{15}, 84$    | 268              | 71,747              | $3.84\times 10^{7}$  | 803,571             | 17.86                       |
| $3000, \nicefrac{1}{15}, 112$   | 201              | 40,358              | $1.62\times 10^{7}$  | 602,679             | 13.39                       |
| $30000, \nicefrac{1}{15}, 112$  | 2,009            | $4.04\times 10^{6}$ | $1.62\times 10^{10}$ | $6.03\times 10^{7}$ | 133.93                      |
| $1000, \nicefrac{1}{30}, 112$   | 134              | 17,937              | $4.80\times 10^{6}$  | 133,929             | 4.46                        |
| $3000, \nicefrac{1}{30}, 112$   | 402              | 161,432             | $1.30\times 10^{8}$  | $1.21\times 10^{6}$ | 13.39                       |
| $30000, \nicefrac{1}{30}, 112$  | 4,018            | $1.61\times 10^{7}$ | $1.30\times 10^{11}$ | $1.21\times 10^{8}$ | 133.93                      |
| $1000, \nicefrac{1}{60}, 112$   | 268              | 71,747              | $3.84\times 10^{7}$  | 267,857             | 4.46                        |
| $3000, \nicefrac{1}{60}, 112$   | 804              | 645,727             | $1.04\times 10^{9}$  | $2.41\times 10^{6}$ | 13.39                       |
| $30000, \nicefrac{1}{60}, 112$  | 8,036            | $6.46\times 10^{7}$ | $1.04\times 10^{12}$ | $2.41\times 10^{8}$ | 133.93                      |
| $1000, \nicefrac{1}{600}, 112$  | 2,679            | $7.17\times 10^{6}$ | $3.84\times 10^{10}$ | $2.68\times 10^{6}$ | 4.46                        |
| $3000, \nicefrac{1}{600}, 112$  | 8,036            | $6.46\times 10^{7}$ | $1.04\times 10^{12}$ | $2.41\times 10^{7}$ | 13.39                       |
| $30000, \nicefrac{1}{600}, 112$ | 80,357           | $6.46\times 10^{9}$ | $1.04\times 10^{15}$ | $2.41\times 10^{9}$ | 133.93                      |
| $3000, \nicefrac{1}{30}, 200$   | 225              | 50,625              | $2.28\times 10^{7}$  | 675,000             | 7.50                        |
| $3000, \nicefrac{1}{30}, 500$   | 90               | 8,100               | $1.46\times 10^{6}$  | 270,000             | 3.00                        |
| $3000, \nicefrac{1}{30}, 1000$  | 45               | 2,025               | 182,250              | 135,000             | 1.50                        |
| $3000, \nicefrac{1}{30}, 1500$  | 30               | 900                 | 54,000               | 90,000              | 1.00                        |
...
| $1000, \nicefrac{1}{15}, 32, 112$  | 4      | 536              | 469      | 62,779              | $8.41\times 10^{6}$  |
| $3000, \nicefrac{1}{15}, 16, 68$   | 12     | 7,941            | 8,438    | $5.58\times 10^{6}$ | $3.70\times 10^{9}$  |
| $3000, \nicefrac{1}{15}, 32, 84$   | 12     | 6,429            | 4,219    | $2.26\times 10^{6}$ | $1.21\times 10^{9}$  |
| $3000, \nicefrac{1}{15}, 16, 80$   | 12     | 6,750            | 8,438    | $4.75\times 10^{6}$ | $2.67\times 10^{9}$  |
| $3000, \nicefrac{1}{15}, 32, 112$  | 12     | 4,821            | 4,219    | $1.70\times 10^{6}$ | $6.81\times 10^{8}$  |
| $30000, \nicefrac{1}{15}, 16, 68$  | 120    | 794,118          | 843,750  | $5.58\times 10^{9}$ | $3.70\times 10^{13}$ |
| $30000, \nicefrac{1}{15}, 32, 84$  | 120    | 642,857          | 421,875  | $2.26\times 10^{9}$ | $1.21\times 10^{13}$ |
| $30000, \nicefrac{1}{15}, 16, 80$  | 120    | 675,000          | 843,750  | $4.75\times 10^{9}$ | $2.67\times 10^{13}$ |
| $30000, \nicefrac{1}{15}, 32, 112$ | 120    | 482,143          | 421,875  | $1.70\times 10^{9}$ | $6.81\times 10^{12}$ |
| $1000, \nicefrac{1}{60}, 16, 68$   | 4      | 3,529            | 3,750    | $3.31\times 10^{6}$ | $2.92\times 10^{9}$  |
| $1000, \nicefrac{1}{60}, 32, 84$   | 4      | 2,857            | 1,875    | $1.34\times 10^{6}$ | $9.57\times 10^{8}$  |
| $1000, \nicefrac{1}{60}, 16, 80$   | 4      | 3,000            | 3,750    | $2.81\times 10^{6}$ | $2.11\times 10^{9}$  |
| $1000, \nicefrac{1}{60}, 32, 112$  | 4      | 2,143            | 1,875    | $1.00\times 10^{6}$ | $5.38\times 10^{8}$  |
| $3000, \nicefrac{1}{60}, 16, 68$   | 12     | 31,765           | 33,750   | $8.93\times 10^{7}$ | $2.36\times 10^{11}$ |
...
| $1000, \nicefrac{1}{15}, 32, 84$   | 234              | 20,926              | $3.74\times 10^{6}$  | 234,375             | 15.62                       |
| $1000, \nicefrac{1}{15}, 16, 80$   | 469              | 43,945              | $8.24\times 10^{6}$  | 468,750             | 31.25                       |
| $1000, \nicefrac{1}{15}, 32, 112$  | 234              | 15,695              | $2.10\times 10^{6}$  | 234,375             | 15.62                       |
| $3000, \nicefrac{1}{15}, 16, 68$   | 1,406            | 465,303             | $3.08\times 10^{8}$  | $4.22\times 10^{6}$ | 93.75                       |
| $3000, \nicefrac{1}{15}, 32, 84$   | 703              | 188,337             | $1.01\times 10^{8}$  | $2.11\times 10^{6}$ | 46.88                       |
| $3000, \nicefrac{1}{15}, 16, 80$   | 1,406            | 395,508             | $2.22\times 10^{8}$  | $4.22\times 10^{6}$ | 93.75                       |
| $3000, \nicefrac{1}{15}, 32, 112$  | 703              | 141,253             | $5.68\times 10^{7}$  | $2.11\times 10^{6}$ | 46.88                       |
| $30000, \nicefrac{1}{15}, 16, 68$  | 14,062           | $4.65\times 10^{7}$ | $3.08\times 10^{11}$ | $4.22\times 10^{8}$ | 937.50                      |
| $30000, \nicefrac{1}{15}, 32, 84$  | 7,031            | $1.88\times 10^{7}$ | $1.01\times 10^{11}$ | $2.11\times 10^{8}$ | 468.75                      |
| $30000, \nicefrac{1}{15}, 16, 80$  | 14,062           | $3.96\times 10^{7}$ | $2.22\times 10^{11}$ | $4.22\times 10^{8}$ | 937.50                      |
| $30000, \nicefrac{1}{15}, 32, 112$ | 7,031            | $1.41\times 10^{7}$ | $5.68\times 10^{10}$ | $2.11\times 10^{8}$ | 468.75                      |
| $1000, \nicefrac{1}{60}, 16, 68$   | 1,875            | 827,206             | $7.30\times 10^{8}$  | $1.88\times 10^{6}$ | 31.25                       |
| $1000, \nicefrac{1}{60}, 32, 84$   | 938              | 334,821             | $2.39\times 10^{8}$  | 937,500             | 15.62                       |
| $1000, \nicefrac{1}{60}, 16, 80$   | 1,875            | 703,125             | $5.27\times 10^{8}$  | $1.88\times 10^{6}$ | 31.25                       |
| $1000, \nicefrac{1}{60}, 32, 112$  | 938              | 251,116             | $1.35\times 10^{8}$  | 937,500             | 15.62                       |
| $3000, \nicefrac{1}{60}, 16, 68$   | 5,625            | $7.44\times 10^{6}$ | $1.97\times 10^{10}$ | $1.69\times 10^{7}$ | 93.75                       |
