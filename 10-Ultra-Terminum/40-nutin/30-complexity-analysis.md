...
|------|----|-----|-----|-----|
| $1000, \nicefrac{1}{15}, 16, 84$     | 469              | 41,853              | $7.47\times 10^{6}$  | 468,750             |
...
| $3000, \nicefrac{1}{15}, 16, 84$     | 1,406            | 376,674             | $2.02\times 10^{8}$  | $4.22\times 10^{6}$ |
...
| $1000, \nicefrac{1}{15}, 32, 112$  | 234              | 15,695              | $2.10\times 10^{6}$  | 234,375             |
| $3000, \nicefrac{1}{15}, 16, 68$   | 1,406            | 465,303             | $3.08\times 10^{8}$  | $4.22\times 10^{6}$ |
| $3000, \nicefrac{1}{15}, 32, 84$   | 703              | 188,337             | $1.01\times 10^{8}$  | $2.11\times 10^{6}$ |
| $3000, \nicefrac{1}{15}, 16, 80$   | 1,406            | 395,508             | $2.22\times 10^{8}$  | $4.22\times 10^{6}$ |
| $3000, \nicefrac{1}{15}, 32, 112$  | 703              | 141,253             | $5.68\times 10^{7}$  | $2.11\times 10^{6}$ |
| $30000, \nicefrac{1}{15}, 16, 68$  | 14,062           | $4.65\times 10^{7}$ | $3.08\times 10^{11}$ | $4.22\times 10^{8}$ |
| $30000, \nicefrac{1}{15}, 32, 84$  | 7,031            | $1.88\times 10^{7}$ | $1.01\times 10^{11}$ | $2.11\times 10^{8}$ |
| $30000, \nicefrac{1}{15}, 16, 80$  | 14,062           | $3.96\times 10^{7}$ | $2.22\times 10^{11}$ | $4.22\times 10^{8}$ |
| $30000, \nicefrac{1}{15}, 32, 112$ | 7,031            | $1.41\times 10^{7}$ | $5.68\times 10^{10}$ | $2.11\times 10^{8}$ |
| $1000, \nicefrac{1}{60}, 16, 68$   | 1,875            | 827,206             | $7.30\times 10^{8}$  | $1.88\times 10^{6}$ |
| $1000, \nicefrac{1}{60}, 32, 84$   | 938              | 334,821             | $2.39\times 10^{8}$  | 937,500             |
| $1000, \nicefrac{1}{60}, 16, 80$   | 1,875            | 703,125             | $5.27\times 10^{8}$  | $1.88\times 10^{6}$ |
| $1000, \nicefrac{1}{60}, 32, 112$  | 938              | 251,116             | $1.35\times 10^{8}$  | 937,500             |
| $3000, \nicefrac{1}{60}, 16, 68$   | 5,625            | $7.44\times 10^{6}$ | $1.97\times 10^{10}$ | $1.69\times 10^{7}$ |
| $3000, \nicefrac{1}{60}, 32, 84$   | 2,812            | $3.01\times 10^{6}$ | $6.46\times 10^{9}$  | $8.44\times 10^{6}$ |
