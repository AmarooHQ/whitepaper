...
A 200-simplex with $B_f = \nicefrac{1}{15}$ has a confirmation rate of $\nicefrac{40}{3} \approx 13.3$ Hz. An 800-simplex with $B_f = \nicefrac{1}{60}$ has the same confirmation rate. This is $\sim 6.5\times$ faster than EOS/Solana, $\sim 159\times$ faster than Eth2, $\sim 200\times$ faster than Ethereum, and $\sim 8,000\times$ faster than Bitcoin.
