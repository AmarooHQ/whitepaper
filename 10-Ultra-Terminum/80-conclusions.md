...
Cardano is an exception, here, as the Cardano/IOHK team has not been pursuing \emph{Layer 1} scalability solutions -- unlike the Eth2 and Polkadot teams -- and are focusing instead on a \emph{Layer 2} solution: Hydra via EUTXOs.
...
Additionally, a network named *Opt.Shard* (for *Optimal Sharding*) is included in these comparisons.
