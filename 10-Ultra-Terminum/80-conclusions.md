...
| $k$, $B_f$, $B_h$                  | Network  | Scaling Factor | TPS per base-chain  | Network-wide TPS    | $k$ vs UT $O(c^3)$           |
|------|---|---|----|-----|-----|
| $250000000, \nicefrac{1}{600}, 80$ | Bitcoin  | 1              | $1.00\times 10^{6}$ | $1.00\times 10^{6}$ | $(1.53\times 10^{-5})\times$ |
| $115700, \nicefrac{1}{20}, 1070$   | Cardano  | 2,163          | $1.00\times 10^{6}$ | $1.00\times 10^{6}$ | $(3.31\times 10^{-2})\times$ |
| $109810, \nicefrac{1}{6}, 288$     | Polkadot | 2,288          | $1.00\times 10^{6}$ | $1.00\times 10^{6}$ | $(3.48\times 10^{-2})\times$ |
| $64600, \nicefrac{1}{12}, 200$     | Eth2     | 3,876          | $1.00\times 10^{6}$ | $1.00\times 10^{6}$ | $(5.92\times 10^{-2})\times$ |
| $5501, \nicefrac{1}{15}, 112$      | UT+PoRs  | 393            | 8,658               | $1.00\times 10^{6}$ | $(6.96\times 10^{-1})\times$ |
