...
| $3000, \nicefrac{1}{15}, 84$   | $\UT{2}$+PoRs | 291            | 3,486              | 254,509             | $(2.96\times 10^{-1})\times$ |
| $3000, \nicefrac{1}{15}, 84$   | $\UT{2}$      | 268            | 3,214              | 860,969             | $(1.0)\times$                |
| $3000, \nicefrac{1}{15}, 68$   | $\UT{2}$+HOT  | 331            | 3,971              | $5.58\times 10^{6}$ | $(6.49)\times$               |
...
| $30000, \nicefrac{1}{15}, 84$   | $\UT{2}$+PoRs | 2,834          | 340,136            | $1.91\times 10^{8}$ | $(2.22\times 10^{-1})\times$ |
| $30000, \nicefrac{1}{15}, 84$   | $\UT{2}$      | 2,679          | 321,429            | $8.61\times 10^{8}$ | $(1.0)\times$                |
| $30000, \nicefrac{1}{15}, 68$   | $\UT{2}$+HOT  | 3,309          | 397,059            | $5.58\times 10^{9}$ | $(6.49)\times$               |
...
| $4844, \nicefrac{1}{15}, 84$       | $\UT{2}$+PoRs | 9,041               | $1.00\times 10^{6}$ | $(6.51\times 10^{-1})\times$ | $3.62\times 10^{6}$     |
| $3154, \nicefrac{1}{15}, 84$       | $\UT{2}$      | 3,553               | $1.00\times 10^{6}$ | $(1.0)\times$                | $1.00\times 10^{6}$     |
| $1692, \nicefrac{1}{15}, 68$       | $\UT{2}$+HOT  | 1,263               | $1.00\times 10^{6}$ | $(1.86)\times$               | 235,703                 |
...
| $1.34\times 10^{8}, \nicefrac{1}{15}, 68, 250$   | $\UT{1}$+HOT | 268,425 | 16,921              | 1,394               |
| $1.34\times 10^{8}, \nicefrac{1}{15}, 84, 250$   | $\UT{2}$     | 536,871 | 2,563               | 211                 |
| $1.34\times 10^{8}, \nicefrac{1}{15}, 68, 250$   | $\UT{2}$+HOT | 536,431 | 1,374               | 113                 |
