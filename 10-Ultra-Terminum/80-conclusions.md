...
Additionally, a network named *Opt.Shard* (for *Optimal Sharding*) is included. This is a theoretical network which uses the \emph{best parameters possible among UT configurations}. No real-world sharded network has come close to this level of performance, and it is incompatible with PoS.
