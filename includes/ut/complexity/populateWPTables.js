 ...
 */  
  ...
  var utNameI = function ($copy_v) {
      ...
      function $tco_loop(v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 87, column 1 - line 87, column 25): " + [ v.constructor.name ]);
      };
      while (!$tco_done) {
          $tco_result = $tco_loop($copy_v);
      };
  ...
  var utNameE = function ($copy_v) {
      ...
      function $tco_loop(v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 96, column 1 - line 96, column 28): " + [ v.constructor.name ]);
      };
      while (!$tco_done) {
          $tco_result = $tco_loop($copy_v);
      };
  ...
  var sToExt = function (s) {
      var $66 = Data_String_CodePoints.length(s) > 0;
      if ($66) {
          return "+\\text{" + (s + "}");
      };
      return "+\\emptyset";
  ...
  var lpCompareTH = Amaroo_WP_Tables_Types.Table.create([ "$k$, $B_f$, $B_h$", "Network", "Eff. $B_h$ (B)", "$\\Sigma$ TPS (tx/s)" ])({
      md: Data_Functor.map(Data_Functor.functorArray)(mkSpacer)([ 5, 6, 3, 3 ]),
      texTabular: "llrr"
  });
  var lpCompare2TH = Amaroo_WP_Tables_Types.Table.create([ "$k$, $B_f$, $B_h$", "Network", "Eff. $B_h$ (B)", "Eff. $D_h$ (B)", "$\\Sigma$ TPS (tx/s)" ])({
      md: Data_Functor.map(Data_Functor.functorArray)(mkSpacer)([ 5, 6, 3, 3, 3 ]),
      texTabular: "llrrr"
  });
  var latexToMathjax = (function () {
      var $200 = Data_String_Common.replaceAll("\\nicefrac")("\\frac");
      var $201 = Data_String_Common.replaceAll("\\UT")("\\text{UT}_");
      var $202 = Data_String_Common.replaceAll("\\UTinf{")("\\text{UT}_{\\aleph ");
      return function ($203) {
  ...
  var showHtmlTable = function (_id) {
      return function (v) {
          var wXmlWNs = function (tag) {
              var $204 = Data_Semigroup.append(Data_Semigroup.semigroupString)("\x0a");
              var $205 = Amaroo_WP_Formatter.wrapXml(tag);
              return function ($206) {
                  return $204($205($206));
              };
          };
          ...
          return latexToMathjax(Amaroo_WP_Formatter.wrapXmlWAttr("table")("id=\"" + (_id + "\""))(Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupString))("\x0a")(wXmlWNs("tr")(join(Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.wrapXml("th"))(v.value0))) + join(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $207 = wXmlWNs("tr");
              var $208 = Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.wrapXml("td"));
              return function ($209) {
                  return $207(join($208($209)));
              };
          })())(v.value2)))));
      };
  };
  ...
  var utName_ = (function () {
      var $210 = Amaroo_WP_Formatter.wrap("$");
      return function ($211) {
          return $210(utName($211));
      };
  })();
  var netToScalingFactor = function (v) {
      return function (aux) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 318, column 1 - line 318, column 45): " + [ v.constructor.name, aux.constructor.name ]);
      };
  };
  var netToTps = function (v) {
      return function (cd) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 331, column 1 - line 331, column 44): " + [ v.constructor.name, cd.constructor.name ]);
      };
  };
  var showNetwork = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 177, column 1 - line 183, column 28): " + [ v.constructor.name ]);
      }
  };
  ...
  var genLpCompare2Row = function (k) {
      return function (v) {
          ...
          var cs = netToChainStats(v.net)(p);
          var tps = (function () {
              var $140 = isAleph(v.net);
              if ($140) {
                  return Data_Number.infinity;
              };
              return netToTps(v.net)(cs);
          })();
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Amaroo_WP_Formatter.fmtPsKBfBh(Amaroo_WP_Calcs.pToPF(p)), Data_Show.show(showNetwork)(v.net) ])(Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdStdMixed))([ cs.effBh, cs.effDh, tps ]));
      };
  };
  ...
  var showMdTable = function (v) {
      return Data_Array.intercalate(Data_Monoid.monoidString)("\x0a")(fixRow2(Data_Functor.map(Data_Functor.functorArray)((function () {
          var $213 = Amaroo_WP_Formatter.wrap("|");
          var $214 = Amaroo_WP_Formatter.wrap(" ");
          var $215 = Data_Array.intercalate(Data_Monoid.monoidString)(" | ");
          return function ($216) {
  ...
  var lpCompareNetworks = (function () {
      var t = Data_Functor.map(Data_Functor.functorArray)((function () {
          var $217 = genCompareRow(3000.0);
          return function ($218) {
              return makeCompareRowConcise($217($218));
          };
      })())(utVsOther);
  ...
  var utVsOther1M = (function () {
      var calc1M = function (v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 255, column 32 - line 257, column 25): " + [ v.oneMTps.constructor.name ]);
      };
...
(function($PS) {
  ...
  var logTable = function (format) {
      return function (v) {
          var showFunc = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 145, column 16 - line 148, column 31): " + [ format.constructor.name ]);
          })();
  ...
  var insertReplacement = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 97, column 1 - line 97, column 108): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
