 ...
 */  
  ...
  var sToExt = function (s) {
      var $62 = Data_String_CodePoints.length(s) > 0;
      if ($62) {
          return "+\\text{" + (s + "}");
      };
      return "+\\emptyset";
  ...
  var utName_ = (function () {
      var $180 = Amaroo_WP_Formatter.wrap("$");
      return function ($181) {
          return $180(utName($181));
      };
  })();
  var netToScalingFactor = function (v) {
      return function (aux) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 314, column 1 - line 314, column 45): " + [ v.constructor.name, aux.constructor.name ]);
      };
  };
  ...
  var showNetwork = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 176, column 1 - line 182, column 28): " + [ v.constructor.name ]);
      }
  };
  ...
  var showMdTable = function (v) {
      return Data_Array.intercalate(Data_Monoid.monoidString)("\x0a")(fixRow2(Data_Functor.map(Data_Functor.functorArray)((function () {
          var $183 = Amaroo_WP_Formatter.wrap("|");
          var $184 = Amaroo_WP_Formatter.wrap(" ");
          var $185 = Data_Array.intercalate(Data_Monoid.monoidString)(" | ");
          return function ($186) {
  ...
  var lpCompareNetworks = (function () {
      var t = Data_Functor.map(Data_Functor.functorArray)((function () {
          var $187 = genCompareRow(3000.0);
          return function ($188) {
              return makeCompareRowConcise($187($188));
          };
      })())(utVsOther);
  ...
  var utVsOther1M = (function () {
      var calc1M = function (v) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 251, column 32 - line 253, column 25): " + [ v.oneMTps.constructor.name ]);
      };
...
(function($PS) {
  ...
  var replaceTable = function (v) {
      return Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))((function () {
          var $50 = Data_Array.intercalate(Data_Monoid.monoidString)("\x0a");
          var $51 = insertReplacement(v);
          var $52 = toBeforeTableAfter(v.value0);
          return function ($53) {
              return $50($51($52(Data_String_Utils.lines($53))));
          };
      })());
  };
