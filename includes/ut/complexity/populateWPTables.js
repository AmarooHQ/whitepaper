...
(function($PS) {
  ...
  var utHOPorsT1 = function (n1) {
      return function (k1) {
          return function (bf) {
              return function (v) {
                  return function (g) {
                      return n1 * (k1 - bf * n1 * porLen(g)(n1));
                  };
              };
          };
      };
  ...
  var utPorsT1Applied = function (n1) {
                  ...
                  var inner = function ($copy_v) {
                      ...
                      function $tco_loop(v) {
                          ...
                          var $33 = v.i >= wontBeMoreThan || (t1 < 0.0 || (t1 < v.t * 0.96 || t1 < v.t && $$Math.remainder($$Math.abs(Prel.log2(bestN)))(1.0) > 1.0e-2));
                          if ($33) {
                              $tco_done = true;
                              return v;
                          };
  ...
  var kTxOld = (function () {
          ...
          var _assertNoHOPoRs = (function () {
              var $99 = !(v.explicitPoRs && v.headerOmission);
              if ($99) {
          ...
          var _asdf = (function () {
              var $100 = $$Math.abs(kTx - kTxOld) < 1.0;
              if ($100) {
                  return Data_Unit.unit;
              };
  ...
  var utChainCalc = function (ps) {
      return function (v) {
          var $106 = v.explicitPoRs && v.headerOmission;
          if ($106) {
...
(function($PS) {
  ...
  var genLpCompareLimitedRow = genLpCompareRow$prime;
  ...
  var compareUtLimOptimizationsA = compareUtOptimizations_({
      ks: _UT_INIT_CONFIG.ks,
      hfs: _UT_INIT_CONFIG.hfs,
      txSize: _UT_INIT_CONFIG.txSize,
      limitN1Ratio: new Data_Maybe.Just(0.667)
  })(optimizationProps1);
 ...
 */  
  ...
  var lpCompareUt1LimitedOptShard = lpCompareTH(Data_Functor.map(Data_Functor.functorArray)(genLpCompareLimitedRow(new Data_Maybe.Just(0.667))(3000.0))(filterUtVsOther([ Bitcoin.value, new UT(new PoRTs(1)), Eth2.value, new UT(new T(1)), new UT(new HOT(1)), OptShard.value ])));
  ...
  exports["compareUtLimOptimizationsA"] = compareUtLimOptimizationsA;
  ...
  exports["lpCompareUt1LimitedOptShard"] = lpCompareUt1LimitedOptShard;
...
(function($PS) {
  ...
  var tree_tiling_v4_table = (function () {
      var mkRow = function (d) {
          ...
          return Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdStdMixed))([ Data_Int.toNumber(d), n_tiles_h, n_tiles, s_n1, s_n2, s_tps1, s_tps2, x_ut_n1 ]);
      };
      var headings = [ "Depth", "$N_{\\text{tiles}|h}$", "$N_{\\text{tiles}}$", "$\\Sigma N_1$", "$\\Sigma N_2$", "$\\Sigma \\text{TPS}_1$", "$\\Sigma \\text{TPS}_2$", "$\\times \\UT{}$" ];
      var l = Data_Array.length(headings);
      return new Amaroo_WP_Tables_Types.Table(headings, {
          md: Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Tables.mkSpacer)(Data_Array.replicate(l + 1 | 0)(3)),
          texTabular: "l" + Amaroo_WP_Tables.repeatSafe(l)("r")
