...
(function($PS) {
  ...
  var utChainCalc = function (ps) {
      return function (v) {
          ...
          var explicitPorsK = hf.bf * n1 * (porBytes + htModBh(hf.bh));
...
(function($PS) {
  ...
  var sToExt = function (s) {
      var $36 = Data_String_CodePoints.length(s) > 0;
      if ($36) {
          return "+\\text{" + (s + "}");
      };
      return "";
  ...
  var optimizationProps = [ {
      ...
      s: "Nesting TPS$\\times$",
      f: function (cs) {
          return Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdStd)((Amaroo_WP_Calcs.auxStats(cs)).scalingFactors.nesting);
      }
  } ];
  ...
  var utName_ = (function () {
      var $112 = Amaroo_WP_Formatter.wrap("$");
      return function ($113) {
          return $112(utName($113));
      };
  })();
  var netToScalingFactor = function (v) {
      return function (aux) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 295, column 1 - line 295, column 45): " + [ v.constructor.name, aux.constructor.name ]);
      };
  };
  var netToTps = function (v) {
      return function (cd) {
          ...
          throw new Error("Failed pattern match at Amaroo.WP.Tables (line 308, column 1 - line 308, column 44): " + [ v.constructor.name, cd.constructor.name ]);
      };
  };
  var showNetwork = {
      show: function (v) {
  ...
  var genCompareRow = function (k) {
      return function (v) {
          ...
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Amaroo_WP_Formatter.fmtPsKBfBh(Amaroo_WP_Calcs.pToPF(p)), Data_Show.show(showNetwork)(v.net) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdPlainMixed))([ cs.effBh, cs.effDh ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdStdTwo))([ scalingFactor, tpsPerBaseChain ]))(Data_Functor.map(Data_Functor.functorArray)(Amaroo_WP_Formatter.fmtDyn(Amaroo_WP_Formatter.fdStdMixed))([ tps ]))));
      };
  };
  ...
  var showTable = function (table) {
      return Data_Array.intercalate(Data_Monoid.monoidString)("\x0a")(fixRow2(Data_Functor.map(Data_Functor.functorArray)((function () {
          var $115 = Amaroo_WP_Formatter.wrap("|");
          var $116 = Amaroo_WP_Formatter.wrap(" ");
          var $117 = Data_Array.intercalate(Data_Monoid.monoidString)(" | ");
          return function ($118) {
              return $115($116($117($118)));
          };
      })())(table)));
  };
  var compareNetsTH = [ [ "$k$, $B_f$, $B_h$", "Network", "Eff.$B_h$", "Eff.$D_h$", "Scale $\\times$", "$\\nicefrac{\\Sigma\\;\\text{TPS}}{N_1}$", "$\\Sigma$ TPS" ], Data_Functor.map(Data_Functor.functorArray)(mkSpacer)([ 5, 6, 2, 2, 3, 4, 3 ]) ];
  ...
  var tpsPor = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ [ "$k$, $B_f$, $B_h$", "$N_1$", utName_(new PoRs(1)) + " TPS", "$N_2$", utName_(new PoRs(2)) + " TPS", "PoR (B)" ], porTableSpacer ])(Data_Functor.map(Data_Functor.functorArray)(genPoRRow(function (cd) {
      return cd.ut.pors;
  }))(utComplexityData));
  var tpsPort = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ [ "$k$, $B_f$, $B_h$", "$N_1$", utName_(new PoRTs(1)) + " TPS", "$N_2$", utName_(new PoRTs(2)) + " TPS", "PoR (B)" ], porTableSpacer ])(Data_Functor.map(Data_Functor.functorArray)(genPoRRow(function (cd) {
      return cd.ut.ports;
  }))(utComplexityData));
  ...
  var compareNets30k = Data_Semigroup.append(Data_Semigroup.semigroupArray)(compareNetsTH)(Data_Functor.map(Data_Functor.functorArray)(genCompareRow(30000.0))(utVsOther));
  var compareNets3k = Data_Semigroup.append(Data_Semigroup.semigroupArray)(compareNetsTH)(Data_Functor.map(Data_Functor.functorArray)(genCompareRow(3000.0))(utVsOther));
  ...
  var compareNets1mTps = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ [ "$k$, $B_f$, $B_h$", "Network", "$\\nicefrac{\\Sigma\\;\\text{TPS}}{N_1}$", "$\\Sigma$ TPS", "$\\UT{2}$ $\\Sigma$ TPS" ], Data_Functor.map(Data_Functor.functorArray)(mkSpacer)([ 5, 5, 3, 3, 3 ]) ])(Data_Functor.map(Data_Functor.functorArray)(genCompare1MRow)(utVsOther1M));
