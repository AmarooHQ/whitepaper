...
utNamesSpec = describe "tables" do
    ...
    describe "should have sensible 1m tps params" do
      let btc = _head utVsOther1M
          ...
          btcUt2Equiv = utChainCalc btcP {headerOmission: false, explicitPoRs: false, hashTruncation: true, onlyNecessaryHeaders: false}
          adaUt2Equiv = utChainCalc adaP {headerOmission: false, explicitPoRs: false, hashTruncation: true, onlyNecessaryHeaders: false}
          ut2Ut2Equiv = utChainCalc ut2P {headerOmission: false, explicitPoRs: false, hashTruncation: true, onlyNecessaryHeaders: false}
          bf = 1.0 / 20.0
          bh = 1070.0 - 32.0
          calcT1 k bf bh = t1
            where
