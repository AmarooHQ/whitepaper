...
tilingSpec = describe "tiling spec" do
    describe "tree_tiling" do
      ...
      it "sigma_tiles v=3" do
        tree_tiling.sigma_tiles {v: 3, d: 0} `shouldEqual` 1
        tree_tiling.sigma_tiles {v: 3, d: 1} `shouldEqual` 4
        tree_tiling.sigma_tiles {v: 3, d: 2} `shouldEqual` 10
        tree_tiling.sigma_tiles {v: 3, d: 3} `shouldEqual` 22
        tree_tiling.sigma_tiles {v: 3, d: 4} `shouldEqual` 46
      it "tiles_at v=4" do
        let v = 4
      ...
      it "simga_tiles v=4" do
        let v = 4
        tree_tiling.sigma_tiles {v, d: 0} `shouldEqual` 1
        tree_tiling.sigma_tiles {v, d: 1} `shouldEqual` 5
        tree_tiling.sigma_tiles {v, d: 2} `shouldEqual` 17
        tree_tiling.sigma_tiles {v, d: 3} `shouldEqual` 53
        tree_tiling.sigma_tiles {v, d: 4} `shouldEqual` (53 + 36*3)
