...
if the fork rule said that $L_{i \cdots j,a} > L_{i \cdots j,b}$ when using L-hashes as the units, then it should give the same result for \emph{all} cases when the units are changed to R-hashes.
