...
- [ ] Be precise about slashing risk: acts of god and political risk of falling out of favor. The risk *is* the cartel; but PoS says that the *cartel* is where the security comes from. A blatant contradiction, and an existential risk for freethinking validators (unlike Bitcoin miners, that are free to create blocks as they see fit, provided they are valid under the protocol.)
- [ ] Redraft the moral argument about energy and transformation. Increase clarity and poignancy.
- [ ] Remove COVID footnote.
- [ ] Extend conclusion with the decisive question ("What virtuous man would create a system so frail?") and conclude that this is no hypothetical future, it is a contemporary fact. It is an abdication of standards in the pursuit of liberty, and thus the ability to attain that liberty is lost. The horror is that they call it what it is not; they call a cancer an organ; they call an oligarchy a democracy; they call this corruption a virtue. It is a lie.
...
(Oh, and, the only reason `here' is on the way is because the validator \emph{paid} for the privilege, and even that only cost opportunity.)
