...
What we're observing is that the overall capacity is the \emph{product} of size of the simplex and each chain's remaining capacity -- a quadratic relationship.
