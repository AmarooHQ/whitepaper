...
\cn{[FIXED] Just a note, previously (page 29, 3.1.3.3 Hold Up!) $t$ is time, \autoref{sec:conversion-single-root-token} has $G_t$, $C_t$ as supply - now $t$ is transctions.
Similarly, $C_r$ is the chain's reward, now $r$ is reflections.}
