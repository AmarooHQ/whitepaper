...
So, \emph{if} the problem of block availability in a tiling can be and is solved, we are clearly $O(n)$ scalable with any tiling.
However, if it remains unsolved then \UTinf2 is not \emph{currently} $O(n)$ scalable, but could potentially reach that in the near future.
