...
\dSe{
    ...
    What does that full node experience?
}
\dMax{
    Well\dots{} it wouldn't reorg\dots{} \\
    Because it never used the attackers branch -- it was invalid.
}
\dMax{
    So it's like a typical newly mined block, except there's a long time between it and the last valid one, and it links back to like potentailly thousands of previous invalid blocks.
}
\dSe{
...
\dSe{
    Retrace the conversation, past all the premises we refuted, back to the last unrefuted thing you said.
}
\dSe{
    What was it?
}
