...
\pz{Is our implementation going to be based on SNARKs and STARKs?}
...
\pz{If $\therefore$ is meant as \emph{therefore} maybe we should use $\Rightarrow$ instead.}
\begin{argumentslist}
...
\pz{Replace RTs with root tokens}
\dSe{
    Only 80 blocks?
...
\pz{What if the $N_1 d$ blocks are mined privately?}
