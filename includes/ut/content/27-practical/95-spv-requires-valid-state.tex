...
\dMax{
    ...
    The attacker wants to bribe other miners.
...
\dMax{
    It'd means that we could reduce the batch delay arbitrarily.
}
\dMax{
...
\dMax{
    And we don't want to have each simplex-chain needing to check each other for consistency -- that's the whole bloody point!
}
\dMax{
    This can't be right.
}
