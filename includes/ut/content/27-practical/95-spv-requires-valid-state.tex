...
\subsubsubsection{Dialog: Error Correction, Part I}
...
\dMax{
    and \emph{you must link back to all local blocks that both are \ul[DMaxCol]{chain-tips} and have been reflected by blocks you reflect}
}
\dMax{
