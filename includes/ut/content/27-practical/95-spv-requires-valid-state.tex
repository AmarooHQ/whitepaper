...
\dMax{
    ...
    The knew the block was invalid because they already had the fraud proof, even if they're not a full node of that chain.
}
\dSe{
    So\dots{}
}
...
\dMax{
    ...
    And it needs to tolerate to the sort of invalidation (via FPs) that might happen.
}
\dSe{
    Mm\dots{} perhaps.
