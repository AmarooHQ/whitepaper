...
The best-blocks half of the proof is almost a regular NIPoPoW on its own, but the other half of the proof (traversing on-main blocks only) does not meet the definition because it is not secure.
...
Thus, it is a \emph{Non-Interactive Proof of Posteritorial\footnote{
