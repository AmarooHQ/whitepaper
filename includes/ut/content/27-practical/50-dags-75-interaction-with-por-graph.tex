...
However, the NIPoPPoW best-blocks proof had substantial overlap with the on-main only proof -- that isn't the case for NIPoPoWRs as \emph{most} of the \mu-superblocks will be from reflecting chains.
