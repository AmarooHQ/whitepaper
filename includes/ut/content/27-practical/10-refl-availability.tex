...
If \BR2 does reflect \BL2, then \BR1 is the only block to which we can attribute the work contributed by \BL2.
Thus \BR2 will claim a greater chain-weight than \BR{2a}.
However, in the context of the next \cR block (\BR3), \BR{2a} will still have precedence over \BR2.
