...
\begin{table}[H]
    ...
    \begin{tabular}{llp{0.64\linewidth}}
        ...
        $DAA_N$ (blocks) & No & The number of blocks over which the DAA operates. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item Decreasing $DAA_N$ increases the security of both simplexes and traditional blockchains -- except for ``Longest Chain'' fork rules.
