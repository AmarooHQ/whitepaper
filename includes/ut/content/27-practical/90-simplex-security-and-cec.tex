...
Note that $P(q; N_1 = 1; c = C)$ is taken to be identical to Rosenfeld's analytical solution.

\autoref{eq:por-sim-hypothesis-extended} is a \emph{generalization} of traditional blockchains (that have $N_1 = 1$).
Particularly, there is \emph{another dimension} (the size of the simplex) and that is related to the other dimension $c$ (some number of confirmations to wait for). Particularly, the CEC says there is a \emph{geometric} relationship between the two.
