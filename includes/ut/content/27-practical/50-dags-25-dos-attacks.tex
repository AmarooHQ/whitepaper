...
If an attacker performs a *repeating cycle* of these attacks, then they may be able to decrease the effective capacity of the chain by a factor of $A_{\text{blocks}}^2$. %<!-- / (1 + A_{\text{blocks}}) -->
