...
\mk{(normally mentioned snarks and stuff here, but we don't want to for new spv)}
...
\mk{note: technically: find blocks matching condition, find LCA of those blocks; calculate the same for the parent. Then get all blocks between LCA (inclusive) and parent's LCA (exclusive).}
