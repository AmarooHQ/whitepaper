...
\begin{figure}
    ...
    \caption{
        ...
        Valid blocks are those that are earlier than (or in) a common ancestor of the four blocks $\{ R_{j-\lambda}, R_{j-k_1}, R_{j-k_2}, R_{j-k_3} \}$.
        $R_j$ is a PoR ancestor of $L_i$ on chain $R$.
        $R_{j-\lambda}$ is a $\lambda$-parent $R_j$.
        $L_{i-\lambda}$ is a $\lambda$-parent $L_i$.
        $R_{j-k_1}$ is a PoR ancestor of $L_{i-\lambda}$ on chain $R$.
        $R_{j-k_2}$ is an ancestor of $L_i$ such that the PoR volume has increased at least $N_1 \lambda$ since $R_{j-k_2}$.
        $R_{j-k_3}$ is an ancestor of $L_i$ that is at least ${B_f}^{-1} \lambda$ older than $L_i$.
        }
