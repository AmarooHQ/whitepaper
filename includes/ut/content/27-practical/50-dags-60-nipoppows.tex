...
Regarding infix proofs, we can use the existing \texttt{followDown} algorithm with only one modification: an additional parameter determines whether \texttt{followDown} should traverse the \emph{best-blocks} path to the block, or the \emph{on-main only} path.
