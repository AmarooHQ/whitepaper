...
Using the \AxiomOfUnifiedAncestry, we do not need to reference to a block's parents directly, since they are implied by the PoR graph and the absence of fraud proofs.
...
Decreasing block times to 15s correspondingly decrease the bandwidth requirements to 0.3 MB/s for a simplex with \(\sim 200\) chains, \(\sim 40,000\) dapp-chains, and \(\sim 484,000\) max tps.
