...
In essence, \emph{Ultra Terminum} is not a method to scale a single blockchain, rather a method to scale a \emph{network} of blockchains.
...
Those blockchains use the technique \emph{Proof of Reflection} (\autoref{sec:proof-of-reflection}) to \emph{mutually secure each other}, forming something called \emph{the simplex} (\autoref{sec:the-simplex}).
