...
At the core of \emph{Ultra Terminum} is a new method for sharing security: \emph{Proof of Reflection} (\Cref{sec:proof-of-reflection}).
...
Finally, a UT simplex can be modified to enable a \emph{tiling of simplexes} (\Cref{sec:tiling}).
