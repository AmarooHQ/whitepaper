...
The nature of blockchain use is also growing, starting off as a niche, underground peer-to-peer digital currency, to now being embedded in global financial institutions and a becoming an increasingly strong narrative for various interconnected applications of varying complexity.
...
These properties, and the notion of only being able to ``\emph{choose two of three}'', quickly highlights potential shortcomings in various designs.
...
Finally, chains that prefer \emph{scalability} and \emph{decentralization} over security may exhibit high performance, but often reduce parameters in their security choices for the sake of inclusivity, for example XXX.
