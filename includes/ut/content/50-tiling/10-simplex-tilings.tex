...
\todo{This tiling doesn't work because children of the root will need (v+1)/v capacity for reflections. mb just better to let the root tile have extra txs and fewer chains? easy solution and gives more tx capacity in root.}
