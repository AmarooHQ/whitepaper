...
The second solution is a long chain of tiles; see \autoref{fig:tiling-v2-unbounded}.
...
If a tiling has a valence of $v=3$, then there are many possible solutions (in fact, there are infinitely many).
We will focus on one particular pattern: the tiling that is also a \emph{tree}.
