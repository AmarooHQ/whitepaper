...
The root tile has \emph{capacity} for $v$ children, and each other tile has capacity for $v-1$ children and 1 parent.
...
Instead, we'll limit the root tile to $v-1$ children to match all other tiles.\footnote{
    Exactly why we should do this will be discussed in \autoref{sec:tiling-security}.
}
...
This scaling configuration is \UTinf{}, and each of \UT1, \UT2, and \UT3 have a corresponding tiling configuration: \UTinf1, \UTinf2, and \UTinf3.
