...
\end{align}
There is no elegant form of \autoref{eq:tree-tiling-safe-q} when solving for $r$,\footnote{%
    % https://www.desmos.com/calculator/jghfe9511e
    ...
    % \end{align*}
} but this form is easy to evaluate and graph, at least.
