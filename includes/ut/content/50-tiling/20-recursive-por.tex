...
Eventually, we will need to answer two questions: \emph{Can the chains in those leaf tiles be secured by the root tile?} and \emph{How do we do this?}
Recursive PoR provides the foundation that we need to answer those questions and analyze the security of our tiling.
...
Particularly, we will need these principles:
\begin{itemize}
...
Firstly, we can say that the total work contributed by all possible PoR paths is equal to the sum of local work contributed by each block in those paths.
...
Additionally, a recursive PoR is, in isolation, worth \emph{exactly} as much as the sum of weights of each block in that PoR.
