...
Let us approach this from first principles.
...
Firstly, we can say that the total work contributed by all possible PoR paths is equal to the sum of local work contributed by each block in those paths to their respective chains.
