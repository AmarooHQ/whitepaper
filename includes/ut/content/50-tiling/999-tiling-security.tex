...
The core of a simplex tiling is the root tile and its children.

All nodes in the network verify the work and PoRs of all simplex-chains that are part of the core.
