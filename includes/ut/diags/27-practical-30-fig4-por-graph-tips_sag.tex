...
\immediate\write18{zsh -c './27-practical-30-fig4-gen.py no_replace_recent entropy=1662445704' 2> 27-practical-30-fig4-autogen.log}
...
\begin{tikzpicture}[node distance=0.1cm]%
    ...
    \tikzstyle{arFocus} = [ar, densely dashed, very thick, opacity=0.7]
    ...
    \tikzstyle{arNone} = [ar, opacity=0.15]
    ...
    \input{./27-practical-30-fig4-refls.tikz}
\end{tikzpicture}%
\end{document}
