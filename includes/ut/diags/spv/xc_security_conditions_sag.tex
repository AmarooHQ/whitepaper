...
\node[squarednode]      (remote4)  [right=of chainrpast]      {$R_{j-x_3}$};
\node[squarednode]      (remote3)  [right=of remote4]         {$R_{j-x_2}$};
\node[squarednode]      (remote2)  [right=of remote3]         {$R_{j-x_1}$};
