...
\begin{tikzpicture}[node distance=0.8cm]
    ...
    \foreach \x in {1,...,3} {
        ...
        \draw [braceLR] (btc\x.west |- btc\x.north) --
            node (btcState\x) [state, anchor=east, xshift=-\stateXS, align=right] {\footnotesize{
                \textsc{STATE} \\
        ...
        \draw [braceRL] (ethS\x.east |- ethS\x.north) --
            node (ethStateCoord\x) [state, anchor=west, xshift=\stateXS] {\footnotesize{
                \textsc{STATE} \\
    ...
    \node (botLeft) [left = of btcState3.west |- btc3.south, minimum width=0, xshift=\xs] {};
