...
\begin{section}{Construction of The Simplex}
 ...
 \begin{subsection}{Modification to Existing PoR Method}
    ...
    Each chain should generalize their reflection capabilities as detailed in \autoref{alg:por-reflected-block-weight}.
    ...
    The foundation for this algorithm is detailed in \autoref{alg:por-simplex}.
