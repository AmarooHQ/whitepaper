...
\begin{section}{Construction of The Simplex}
 ...
 \begin{subsection}{Modification to Existing PoR Method}
    ...
    Each chain should generalize their reflection capabilities as detailed in \autoref{alg:por-reflected-block-weight}. Note that this includes a cap on each simplex-chain's contribution, which is optional.
