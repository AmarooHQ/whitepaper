...
# Experiment 19: inverse of exp 18: ATK_END_TICK set higher (so more time for a DS to happen)
export EXP_NUM=19
...
export ATK_END_MULT=15
# default in makefile is: $(ATK_DS_CONFS)\*$(B_PERIOD)\*7+$(ATK_START_TICK)
# set to a buffer of 15x instead of 7x
# export ATK_END_TICK=$(echo $ATK_DS_CONFS\*$B_PERIOD\*$ATK_END_MULT+$ATK_START_TICK | bc)
